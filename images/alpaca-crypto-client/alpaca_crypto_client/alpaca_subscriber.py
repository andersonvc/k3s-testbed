...
class L2CryptoDataStream(CryptoDataStream):
    ...
    def subscribe_orderbook(self, handler, symbols:str):
        parsed_symbols = symbols.split(',')
        self._subscribe(handler, parsed_symbols, self._handlers["orderbooks"])
    ...
    def _orderbook_cast(self, msg: Dict) -> Dict:
        ...
        if not self._raw_data:
            ...
            result = CustomOrderbook(msg["S"], msg, is_full=msg["r"]).dict()
        return result
